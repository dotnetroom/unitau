...
using MvcFundamentals.Models.Context;

namespace MvcFundamentals.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20161118172044_FirstUse")]
    partial class FirstUse
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("MvcFundamentals.Models.Identity.ApplicationUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("MvcFundamentals.Models.Identity.ApplicationUser")
                        .WithMany("Claims")
